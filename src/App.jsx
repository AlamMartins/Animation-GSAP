...
function App() {
  ...
  // Utilizando referência com useRef
  const el = useRef();
  const tl = useRef();


  // Criando a primeria animação
  useLayoutEffect(() => {
  ...
  return (
    <div className="container">
      ...
      {/* SECTION 1 - Área do Relogio - Realizado animação de scroll */}
      ...
      {/* SECTION 2 - Área com vários relógios - Realizado animação de scroll */}
